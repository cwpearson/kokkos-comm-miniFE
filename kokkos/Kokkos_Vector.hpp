...
//
// Retrieved from Kokkos commit 1696595410c18ff47c36e8435f6d24b78d339665^
// (last commit before Kokkos_Vector.hpp was removed in PR #8957).
// Deprecated-code guards stripped so the header works without
